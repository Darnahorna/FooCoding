...
SELECT country.Name FROM new_world.country INNER JOIN new_world.city ON country.Code=city.CountryCode GROUP BY country.Name HAVING count(city.Name)>10 AND sum(city.Population)>50000000;
